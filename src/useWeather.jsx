    ...
    if (city) {
      ...
      try {
        const cityKeyResponse = await Axios.get(
          `https://dataservice.accuweather.com/locations/v1/cities/search?apikey=${apiKey}&q=${city}&language=pl-Pl`
        );
        const cityKey = cityKeyResponse.data[0]?.Key;
        switch (weatherOption) {
          case "oneDay":
            const oneDayWeatherResponse = await Axios.get(
              `https://dataservice.accuweather.com/forecasts/v1/daily/1day/${cityKey}?apikey=${apiKey}&language=pl-PL`
            );
            const iconDayNumber =
          ...
          case "fiveDays":
            const fiveDaysWeatherResponse = await Axios.get(
              `https://dataservice.accuweather.com/forecasts/v1/daily/5day/${cityKey}?apikey=${apiKey}&language=pl-PL`
            );
            const iconDayOneNumber =
              fiveDaysWeatherResponse.data.DailyForecasts[0].Day.Icon;
            const iconNightOneNumber =
              fiveDaysWeatherResponse.data.DailyForecasts[0].Night.Icon;
            const iconDayTwoNumber =
              fiveDaysWeatherResponse.data.DailyForecasts[1].Day.Icon;
            const iconNightTwoNumber =
              fiveDaysWeatherResponse.data.DailyForecasts[1].Night.Icon;
            const iconDayThreeNumber =
              fiveDaysWeatherResponse.data.DailyForecasts[2].Day.Icon;
            const iconNightThreeNumber =
              fiveDaysWeatherResponse.data.DailyForecasts[2].Night.Icon;
            const iconDayFourNumber =
              fiveDaysWeatherResponse.data.DailyForecasts[3].Day.Icon;
            const iconNightFourNumber =
              fiveDaysWeatherResponse.data.DailyForecasts[3].Night.Icon;
            const iconDayFiveNumber =
              fiveDaysWeatherResponse.data.DailyForecasts[4].Day.Icon;
            const iconNightFiveNumber =
              fiveDaysWeatherResponse.data.DailyForecasts[4].Night.Icon;
            setWeather({
              state: "succes",
              city: cityKeyResponse.data[0]?.LocalizedName,
              ...
              nightOneIcon: Icon.find(({ id }) => id === iconNightOneNumber)
                .icon,
              dayTwoIcon: Icon.find(({ id }) => id === iconDayTwoNumber).icon,
              nightTwoIcon: Icon.find(({ id }) => id === iconNightTwoNumber)
                .icon,
              dayThreeIcon: Icon.find(({ id }) => id === iconDayThreeNumber)
                .icon,
              nightThreeIcon: Icon.find(({ id }) => id === iconNightThreeNumber)
                .icon,
              dayFourIcon: Icon.find(({ id }) => id === iconDayFourNumber).icon,
              nightFourIcon: Icon.find(({ id }) => id === iconNightFourNumber)
                .icon,
              dayFiveIcon: Icon.find(({ id }) => id === iconDayFiveNumber).icon,
              nightFiveIcon: Icon.find(({ id }) => id === iconNightFiveNumber)
                .icon,
              dayOneInfo:
                fiveDaysWeatherResponse.data.DailyForecasts[0].Day.IconPhrase,
              nightOneInfo:
                fiveDaysWeatherResponse.data.DailyForecasts[0].Night.IconPhrase,
              dayTwoInfo:
                fiveDaysWeatherResponse.data.DailyForecasts[1].Day.IconPhrase,
              nightTwoInfo:
                fiveDaysWeatherResponse.data.DailyForecasts[1].Night.IconPhrase,
              dayThreeInfo:
                fiveDaysWeatherResponse.data.DailyForecasts[2].Day.IconPhrase,
              nightThreeInfo:
                fiveDaysWeatherResponse.data.DailyForecasts[2].Night.IconPhrase,
              dayFourInfo:
                fiveDaysWeatherResponse.data.DailyForecasts[3].Day.IconPhrase,
              nightFourInfo:
                fiveDaysWeatherResponse.data.DailyForecasts[3].Night.IconPhrase,
              dayFiveInfo:
                fiveDaysWeatherResponse.data.DailyForecasts[4].Day.IconPhrase,
              nightFiveInfo:
                fiveDaysWeatherResponse.data.DailyForecasts[4].Night.IconPhrase,
              dayOneTemperature: (
                (fiveDaysWeatherResponse.data.DailyForecasts[0].Temperature
                  .Maximum.Value -
                  32) *
                0.5555556
              ).toFixed(1),
              ...
              dayTwoTemperature: (
                (fiveDaysWeatherResponse.data.DailyForecasts[1].Temperature
                  .Maximum.Value -
                  32) *
                0.5555556
              ).toFixed(1),
              ...
              dayThreeTemperature: (
                (fiveDaysWeatherResponse.data.DailyForecasts[2].Temperature
                  .Maximum.Value -
                  32) *
                0.5555556
              ).toFixed(1),
              nightThreeTemperature: (
                (fiveDaysWeatherResponse.data.DailyForecasts[2].Temperature
                  .Minimum.Value -
                  32) *
                0.5555556
              ...
              dayFourTemperature: (
                (fiveDaysWeatherResponse.data.DailyForecasts[3].Temperature
                  .Maximum.Value -
                  32) *
                0.5555556
              ).toFixed(1),
              nightFourTemperature: (
                (fiveDaysWeatherResponse.data.DailyForecasts[3].Temperature
                  .Minimum.Value -
                  32) *
                0.5555556
              ...
              dayFiveTemperature: (
                (fiveDaysWeatherResponse.data.DailyForecasts[4].Temperature
                  .Maximum.Value -
                  32) *
                0.5555556
              ).toFixed(1),
              nightFiveTemperature: (
                (fiveDaysWeatherResponse.data.DailyForecasts[4].Temperature
                  .Minimum.Value -
                  32) *
                0.5555556
          ...
          case "hours":
            const houersWeatherResponse = await Axios.get(
              `https://dataservice.accuweather.com/forecasts/v1/hourly/12hour/${cityKey}?apikey=${apiKey}&language=pl-PL`
            );
          ...
          default:
            const defaultWeatherResponse = await Axios.get(
              `https://dataservice.accuweather.com/currentconditions/v1/${cityKey}?apikey=${apiKey}&language=pl-PL`
            );
